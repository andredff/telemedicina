...
const Farmacia = () => {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      {/* ── Floating cart bar ─────────────────────────────────────────────── */}
      {cartCount > 0 && (
        <div className="fixed bottom-6 left-1/2 -translate-x-1/2 z-20 w-max">
          <Card className="shadow-xl border-primary/20">
            <CardContent className="flex items-center gap-4 p-3 pr-4">
              ...
              <Button size="sm" onClick={() => navigate("/cart")} className="ml-2 gap-1.5">
                Ver Carrinho →
              </Button>
            </CardContent>
          </Card>
